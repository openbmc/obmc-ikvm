...
create_hid() {
    ...
    cd "${hid_conf_directory}" || \
        { echo "Error changing folder to ${hid_conf_directory}"; return; }
...
if [ ! -e "${hid_conf_directory}" ]; then
    ...
    cd "${hid_conf_directory}" || \
        { echo "Error changing directory to ${hid_conf_directory}"; exit; }
fi
...
cd "${original_directory}" || \
    { echo "Error changing directory to ${original_directory}"; exit; }
